...
}
{
  ...
  {
    border code=\pgfsetlinewidth{2pt}\color{brown}\pgfstroke,%
...
\fancypagestyle{first}{%
	...
	\fancyfoot[C]{\large Monthly Burger Specials\\All Sandwiches come with Handful of Chips and Pickle Spear\\Lettuce - Tomato - Onions available upon request}
...
\newcommand*\Item[2]{%
	\sffamily\textbf{\large#1}\dotfill & \large#2}
...
\begin{document}\thispagestyle{first}
	...
	\begin{Group}{Salvo Burgers}
		...
		\Desc{Served on Grilled Texas Toast, with Pepperjack Cheese, Bacon, Fried Onions, Jalape\~{n}o \\\sffamily\hspace*{0.5cm}Bottle Caps, Chipotle BBQ, and Cajun Seasoning} \\
		...
		\Desc{Served on Grilled Texas Toast, with Pepperjack and Swiss Cheese, Peppercorn Ranch, \\\sffamily\hspace*{0.5cm}Ham, and Fried Onions} \\
		\Item{Pile Driver}{7.50} \\
		\Desc{Served on a Bakery Roll, with Cheddar and Pepperjack Cheese, Stacked Ham, and Fried \\\sffamily\hspace*{0.5cm}Onions} \\
	\end{Group}
