...
\fancypagestyle{first}{%
	...
	\headheight 77pt
	\footskip 30pt
	\fancyhead[C]{\textbf{\Huge Salvo's Coyote Grill}\\\Large 132 W. Center Street, Whitewater, WI\\262-472-0510\\Great for takeout, but give us 20 minutes}
	\fancyfoot[C]{\large All Sandwiches come with Handful of Chips and Pickel Spear\\Lettuce - Tomato - Onions available upon request}
...
\fancypagestyle{second}{%
	...
	\headheight 30pt
	\footskip 70pt
	%\fancyhead[C]{\Huge \textbf{Salvo's Coyote Grill}}
	
	\fancyhead[C]{\includegraphics[height=1.5in]{coyote grill logo wide.png}}
